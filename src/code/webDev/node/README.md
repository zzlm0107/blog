...
**值得注意的是，在node中文网首页官方还放置了多个其他热门库的中文网链接，我注意到他们都经过了中文的汉化，并且挂载在了node的域名下（之前我学习的时候都还没有这些）；有部分热门库的官方网站都没有汉化完全，但这里已经完全中文化，我不知道这是不是node官方自己做汉化的（很大可能是），但这无疑为前端中文社区提供了巨大的帮助支持，让无数初学者免去了硬啃英文文档的烦恼，在此由衷的表达对node中文网维护人员的敬意。**
