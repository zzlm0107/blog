import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,f as e}from"./app-5eb496d1.js";const p={},t=e(`<h2 id="sass学习" tabindex="-1"><a class="header-anchor" href="#sass学习" aria-hidden="true">#</a> Sass学习</h2><h3 id="注释" tabindex="-1"><a class="header-anchor" href="#注释" aria-hidden="true">#</a> 注释</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>单行注释： / / css文件里不会显示 压缩方式的css不会显示
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><em>如果像让sass文件不进行编译，如只用来定义全局变量的sass文件，只需要对文件重命名在前面加上一个 <strong>下划线 _</strong> 即可。</em></p>`,46),c=[t];function i(l,o){return n(),a("div",null,c)}const u=s(p,[["render",i],["__file","sass.html.vue"]]);export{u as default};
