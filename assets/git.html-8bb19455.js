import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-5eb496d1.js";const t={},i=e(`<h2 id="git基本命令" tabindex="-1"><a class="header-anchor" href="#git基本命令" aria-hidden="true">#</a> git基本命令</h2><p>git使用前 配置提交人信息</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> config <span class="token parameter variable">--global</span> user.name 姓名       配置姓名
...
css/*.js						忽略指定后缀名文件
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,28),d=[i];function l(c,o){return s(),a("div",null,d)}const u=n(t,[["render",l],["__file","git.html.vue"]]);export{u as default};
